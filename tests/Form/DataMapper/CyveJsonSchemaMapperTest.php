...
namespace mmo\sf\tests\Form\DataMapper;

use mmo\sf\Form\DataMapper\CyveJsonSchemaMapper;
use mmo\sf\tests\data\TypehintedPropertiesCar;
...
/**
 * Copied from PropertyPathMapperTest of symfony/form.
 *
 * @link https://github.com/symfony/form/blob/81ecf3053c26096261c76ccb049d35c0ce60aa84/Tests/Extension/Core/DataMapper/PropertyPathMapperTest.php
 */
class CyveJsonSchemaMapperTest extends TestCase
{
    /**
     * @var CyveJsonSchemaMapper
     */
    private $mapper;
    ...
    protected function setUp(): void
    {
        ...
        $this->mapper = new CyveJsonSchemaMapper($this->propertyAccessor);
    }
